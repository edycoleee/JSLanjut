...
//select .lorem-form(diambil button clik) ,
//amount (diambil nilai) , .lorem.text(menampilkan text)
const loremForm = document.querySelector(".lorem-form");
const amount = document.getElementById("amount");
const result = document.querySelector(".lorem-text");
console.log(loremForm, amount, result);

// listen form
// karena bertipe submit maka setelah klik
// secara default akan hilang variable yang dikirim
// karena itu perlu di prevent default utk menghentikannya
loremForm.addEventListener("submit", function (e) {
  e.preventDefault();
  //const value = amount.value
  //console.log('hello',value);
  //pertama kali di klik generate tidak muncul nilainya
  //mari kita lihat apa type datanya
  //console.log(typeof value);
  // oOo ternyata bentuknya string
